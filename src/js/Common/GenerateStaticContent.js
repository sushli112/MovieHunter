...
export default class GenerateStaticContent {
  constructor() {
    ...
    const modalTemplate = ` <div class="modal fade" id="exampleModalsearch" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="popup-content">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabelsearch">Movie Detail</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="card d-flex flex-row mainCard">
                            <img class="card-img-left" src="./src/img/jurassicPark.jpg" id="popupImgsearch" alt="Card image cap">
                            <div class="card-body" id="infosearch">
                                <div id="title">
                                    <h5 class="card-title" id="movieTttlesearch"></h5>
                                    <h6 class="card-subtitle mb-2 text-muted" id="movieRelDatesearch"></h6>
                                </div>
                                <p class="card-text" id="movieDescsearch">
                                </p>
                                <label data-error="wrong" data-success="right" for="inlineFormCustomSelectsearch">Select Your List</label>
                                <select class="custom-select mb-2 mr-sm-2 mb-sm-0" id="inlineFormCustomSelectsearch">
                                    <option selected>Choose...</option>
                                    <option value="action">Action</option>
                                    <option value="adventure">Adventure</option>
                                    <option value="comic">Comic</option>
                    ...
                    <div class="modal-footer">
                        <button type="button" id="closesearch" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="button" id="addsearch" class="btn btn-primary" data-dismiss="modal">Add</button>
                    </div>
                </div>
            </div>
        </div>
