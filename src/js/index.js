...
let headerObj = new HeaderController();
let footerObj = new FooterController();
let PopularListObj = new PopularListController();
let collectionObj = new CollectionController();
